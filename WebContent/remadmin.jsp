...
String query="select * from admin where admin_mail!='admin@foodzilla.com'";

out.println("<form name=\"AdminRemovalForm\" action=\"remadmin.jsp\" method=\"POST\">");
out.println("<table border=\"0\" bgcolor=\"#cceeff\">");
out.println("<tr><td style='width: 150px; color: blue;'>Admin ID</td>");
out.println("<td style='width: 150px; color: blue;'>First Name</td>");
out.println("<td style='width: 150px; color: blue; '>Last Name</td>");
out.println("<td style='width: 20px; color: blue;'>  </td></tr>");
...
while(R.next())
{
	out.println("<tr><td style='width: 150px;'>" + R.getInt("admin_id") + "  </td>");
	out.println("<td style='width: 150px;'>" + R.getString("firstname") + "  </td>");
    out.println("<td style='width: 150px; '>" + R.getString("lastname") + "   </td>");
    out.println("<td style='width: 20px;'> <button type =\"submit\" name =\"removebtn\" value=\""+R.getInt("admin_id")+ "\"> Delete </button></td></tr>");
...
{	
	...
	String sadmin_id=(String)request.getParameter("removebtn");
	int admin_id=Integer.parseInt(sadmin_id);
	String query=null;
	...
	if(i>0)
	{
			out.println("Admin removed successfully. <br>");
