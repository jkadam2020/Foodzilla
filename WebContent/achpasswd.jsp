...
out.println("</div></div>");
%>
<h3>Please Enter below your password</h3>
<form name="aChPasswdForm1" action="achpasswd.jsp" method="post">
<table>
        <tr>
...
int i=0;
String query="UPDATE ADMIN SET PASSWORD='"+password+"' WHERE ADMIN_MAIL='"+usermail+"'";
