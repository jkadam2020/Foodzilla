...
while(R.next())
{
	...
	out.println("<tr><td style='width: 200px;' colspan=\"3\"> Restaurant: " + R3.getString("rname") + " </td></tr>");
    ...
    out.println("<br>");
    out.println("<br>");
    out.println("<h3> Thank you for placing an order with us. </h3>");
    out.println("<h3> Please follow up the order status under 'Orders'. </h3>");
    out.println("<h3> Please pay in cash on delivery(Card Swipe facility also available). </h3>");
    out.println("<h3> Standard delivery time is 30 minutes.(*Conditions Apply) </h3>");
    i++;
	}
}
